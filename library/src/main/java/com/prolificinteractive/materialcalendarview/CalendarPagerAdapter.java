...
abstract class CalendarPagerAdapter<V extends CalendarPagerView> extends PagerAdapter {
    ...
    private final com.prolificinteractive.materialcalendarview.CalendarDay today;

    private TitleFormatter titleFormatter = null;
    private Integer color = null;
    private Integer dateTextAppearance = null;
    private Integer unfocusedDateTextAppearance = null;
    private Integer selectedDateTextAppearance = null;
    private Integer weekDayTextAppearance = null;
    private DrawableShape selectedDrawableShape = DrawableShape.CIRCLE;
    @ShowOtherDates
    private int showOtherDates = MaterialCalendarView.SHOW_DEFAULTS;
    private com.prolificinteractive.materialcalendarview.CalendarDay minDate = null;
    private com.prolificinteractive.materialcalendarview.CalendarDay maxDate = null;
    private DateRangeIndex rangeIndex;
    private List<com.prolificinteractive.materialcalendarview.CalendarDay> selectedDates = new ArrayList<>();
    ...
    CalendarPagerAdapter(MaterialCalendarView mcv) {
        this.mcv = mcv;
        this.today = com.prolificinteractive.materialcalendarview.CalendarDay.today();
    ...
    public CalendarPagerAdapter<?> migrateStateAndReturn(CalendarPagerAdapter<?> newAdapter) {
        ...
        newAdapter.unfocusedDateTextAppearance = unfocusedDateTextAppearance;
        newAdapter.selectedDateTextAppearance = selectedDateTextAppearance;
        ...
        newAdapter.selectedDrawableShape = selectedDrawableShape;
        return newAdapter;
    }

    public int getIndexForDay(com.prolificinteractive.materialcalendarview.CalendarDay day) {
        if (day == null) {
            return getCount() / 2;
        }
    ...
    protected abstract DateRangeIndex createRangeIndex(com.prolificinteractive.materialcalendarview.CalendarDay min, com.prolificinteractive.materialcalendarview.CalendarDay max);
    ...
    public int getItemPosition(Object object) {
        ...
        com.prolificinteractive.materialcalendarview.CalendarDay month = monthView.getMonth();
        if (month == null) {
            return POSITION_NONE;
        }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        pagerView.setSelectedDrawableShape(selectedDrawableShape);

        if (dateTextAppearance != null) {
            pagerView.setDateTextAppearance(dateTextAppearance);
        }
        if (unfocusedDateTextAppearance != null) {
            pagerView.setUnfocusedDateTextTextAppearance(unfocusedDateTextAppearance);
        }
        if (selectedDateTextAppearance != null) {
            pagerView.setSelectedDateTextTextAppearance(selectedDateTextAppearance);
        }
    ...
    public void setSelectedDrawableShape(DrawableShape shape) {
        this.selectedDrawableShape = shape;
        for (V pagerView : currentViews) {
            pagerView.setSelectedDrawableShape(shape);
        }
    }
    ...
    public void setUnfocusedDateTextAppearance(int taId) {
        if (taId == 0) {
            return;
        }
        this.unfocusedDateTextAppearance = taId;
        for (V pagerView : currentViews) {
            pagerView.setUnfocusedDateTextTextAppearance(taId);
        }
    }

    public void setSelectedDateTextAppearance(int taId) {
        if (taId == 0) {
            return;
        }
        this.selectedDateTextAppearance = taId;
        for (V pagerView : currentViews) {
            pagerView.setSelectedDateTextTextAppearance(taId);
        }
    }
    ...
    public void setRangeDates(com.prolificinteractive.materialcalendarview.CalendarDay min, com.prolificinteractive.materialcalendarview.CalendarDay max) {
        this.minDate = min;
        this.maxDate = max;
        for (V pagerView : currentViews) {
        ...
        if (min == null) {
            min = com.prolificinteractive.materialcalendarview.CalendarDay.from(today.getYear() - 200, today.getMonth(), today.getDay());
        }

        if (max == null) {
            max = com.prolificinteractive.materialcalendarview.CalendarDay.from(today.getYear() + 200, today.getMonth(), today.getDay());
        }
    ...
    public void setDateSelected(com.prolificinteractive.materialcalendarview.CalendarDay day, boolean selected) {
        if (selected) {
    ...
    private void validateSelectedDates() {
        for (int i = 0; i < selectedDates.size(); i++) {
            com.prolificinteractive.materialcalendarview.CalendarDay date = selectedDates.get(i);
    ...
    public com.prolificinteractive.materialcalendarview.CalendarDay getItem(int position) {
        return rangeIndex.getItem(position);
    }

    @NonNull
    public List<com.prolificinteractive.materialcalendarview.CalendarDay> getSelectedDates() {
    ...
    protected int getUnfocusedDateTextAppearance() {
        return unfocusedDateTextAppearance == null ? 0 : unfocusedDateTextAppearance;
    }

    protected int getSelectedDateTextAppearance() {
        return selectedDateTextAppearance == null ? 0 : selectedDateTextAppearance;
    }
