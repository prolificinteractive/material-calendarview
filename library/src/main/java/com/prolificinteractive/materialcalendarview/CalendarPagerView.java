...
abstract class CalendarPagerView extends ViewGroup implements View.OnClickListener {
    ...
    public void setDateTextAppearance(int taId) {
        ...
        invalidateTextAppearance();
    }

    public void setUnfocusedDateTextTextAppearance(int taId) {
        this.unfocusedDateTextAppearance = taId;
        invalidateTextAppearance();
    }

    public void setSelectedDateTextTextAppearance(int taId) {
    ...
    protected void invalidateDrawableShape() {
        for (DayView dayView : dayViews) {
            dayView.setSelectedDrawableShape(selectedDrawableShape);
        }
    }

    protected void invalidateTextAppearance() {
        for (DayView dayView : dayViews) {
            if(dayView.isInMonth()) {
                if(dateTextAppearance != null) {
                    dayView.setTextAppearance(getContext(), dateTextAppearance);
                }
            }
            if(!dayView.isInMonth()) {
                if(unfocusedDateTextAppearance != null) {
                    dayView.setTextAppearance(getContext(), unfocusedDateTextAppearance);
                }
            }
            if(dayView.isSelected()) {
                if(selectedDateTextAppearance != null) {
                    dayView.setTextAppearance(getContext(), selectedDateTextAppearance);
                }
            }
        }
    }
