...
abstract class CalendarPagerView extends ViewGroup
    ...
    CalendarPagerView(Context context) {
        super(context);
    }

    CalendarPagerView(Context context, AttributeSet attributeSet) {
    ...
    private void buildWeekDays(@Nullable LocalDate calendar) {
        if (calendar != null) {
    ...
    protected LocalDate resetAndGetWorkingCalendar() {
        ...
        final CalendarDay firstViewDay = getFirstViewDay();
