...
public class MaterialCalendarView extends ViewGroup {
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            newState().setFirstDayOfWeek(firstDayOfWeek).setCalendarDisplayMode(CalendarMode.values()[calendarModeIndex]).setShowWeekDays(showWeekDays).commit();
            setSelectionMode(a.getInteger(R.styleable.MaterialCalendarView_mcv_selectionMode, SELECTION_MODE_SINGLE));
            ...
            setLeftArrow(a.getResourceId(R.styleable.MaterialCalendarView_mcv_leftArrow, R.drawable.mcv_action_previous));
            setRightArrow(a.getResourceId(R.styleable.MaterialCalendarView_mcv_rightArrow, R.drawable.mcv_action_next));
     ...
     */
    public void setSelectionMode(@SelectionMode final int mode) {
        @SelectionMode
        final int oldMode = this.selectionMode;
