...
import com.eagleteam.calendarview.format.ArrayWeekDayFormatter;
import com.eagleteam.calendarview.format.DayFormatter;
import com.eagleteam.calendarview.format.MonthArrayTitleFormatter;
import com.eagleteam.calendarview.format.TitleFormatter;
import com.eagleteam.calendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            DayView.textSizeNormalDate = (int) a.getDimension(
                    R.styleable.MaterialCalendarView_mcv_textSizeNormalDate, 0
            );
            DayView.textSizeSelectedDate = (int) a.getDimension(
                    R.styleable.MaterialCalendarView_mcv_textSizeSelectedDate, 0
            );
            DayView.normalDateColor = a.getColor(
                    R.styleable.MaterialCalendarView_mcv_normalDateColor,
                    Color.parseColor("#000000")
            );
            DayView.selectedDateColor = a.getColor(
                    R.styleable.MaterialCalendarView_mcv_selectedDateColor,
            ...
            DayView.lichAmTextSize = (int) a.getDimension(
                    R.styleable.MaterialCalendarView_mcv_lichAmTextSize,
                    0
            );
            DayView.lichAmTextColorUnSelect = a.getColor(
                    R.styleable.MaterialCalendarView_mcv_lichAmTextColorUnSelect,
                    Color.parseColor("#BDBDBD")
            );
            DayView.lichAmTextColorSelected = a.getColor(
                    R.styleable.MaterialCalendarView_mcv_lichAmTextColorSelected,
    ...
    /**
     * Set a {@linkplain com.eagleteam.calendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.eagleteam.calendarview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.eagleteam.calendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.eagleteam.calendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.eagleteam.calendarview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.eagleteam.calendarview.format.TitleFormatter)
     */
